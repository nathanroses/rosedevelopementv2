  ...
  <section id="faqsTwo">
    <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      ...
      <Collapse
        ...
        iconUp={<IconChevronUp className="h-6 w-6 text-purple-600 dark:text-slate-200" />}
        iconDown={<IconChevronDown className="h-6 w-6 text-purple-600 dark:text-slate-200" />}
      />
    </div>
  </section>
);
