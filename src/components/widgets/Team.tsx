                      ...
                      items.map(
                        ({ title, href, icon: Icon }, index2) =>
                          ...
                          href && (
                            <li
                              key={`team-${index2}`}
                              className="m-1 flex items-center justify-center rounded text-purple-700 hover:text-gray-500"
                            >
                              <a
                                href={href}
                                target="_blank"
                                ...
                                className="flex items-center justify-center rounded-sm bg-transparent p-0.5 text-purple-900 hover:bg-purple-900 hover:text-slate-200 hover:dark:bg-slate-800 hover:dark:text-slate-200"
                              >
